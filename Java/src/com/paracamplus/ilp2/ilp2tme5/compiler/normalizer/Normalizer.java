...
implements IASTvisitor<IASTexpression, INormalizationEnvironment, CompilationException> {
    ...
    @Override
    public IASTexpression visit(IASTbreak iast, INormalizationEnvironment iNormalizationEnvironment) throws CompilationException {
        return ((INormalizationFactory)factory).newBreak();
    }

    @Override
    public IASTexpression visit(IASTcontinue iast, INormalizationEnvironment iNormalizationEnvironment) throws CompilationException {
