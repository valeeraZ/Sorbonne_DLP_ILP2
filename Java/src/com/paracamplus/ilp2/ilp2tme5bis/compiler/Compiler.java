...
import com.paracamplus.ilp2.ilp2tme5bis.compiler.normalizer.INormalizationFactory;
import com.paracamplus.ilp2.ilp2tme5bis.compiler.normalizer.NormalizationFactory;
import com.paracamplus.ilp2.ilp2tme5bis.compiler.normalizer.Normalizer;
...
implements IASTCvisitor<Void, Compiler.Context, CompilationException> {
    ...
    @Override
    public Void visit(IASTloop iast, Context context) throws CompilationException {
        emit("while ( 1 ) { \n");
